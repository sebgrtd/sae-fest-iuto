...
export default function PageArtiste() {
    ...
    useEffect(() => {
      ...
      if (location.state && location != null){
        axios.get('https://www.api.festiuto.sebastien-gratade.fr/getInfosSupplementairesArtiste?idGroupe='+idArtiste).then((res) => {
        ...
        axios.get("https://www.api.festiuto.sebastien-gratade.fr/getInfosArtiste?idGroupe="+idArtiste).then((res) => {
    ...
    animate={infosGridPosition === "top" ? "extended" : "initial"}
      ...
      <img src={"https://www.api.festiuto.sebastien-gratade.fr/getImageArtiste/"+idArtiste} alt="image de fond" />
